...
from database.db import get_user_interviews, has_used_interview, has_used_interview
...
def home_page(kpis: dict, user_email: str):
    ...
    if has_used_interview(user_email):
        ...
        <div style="
            ...
            <div style="font-size:22px;font-weight:800;
                ...
                Interview Already Used
            </div>
            <div style="font-size:14px;color:#94a3b8;max-width:460px;
                        margin:0 auto 20px auto;line-height:1.7;">
                Each verified account gets
                <b style="color:#00d4ff;">1 free AI interview</b>.
                You have already completed yours.<br>
                Head to History to download your PDF report.
            </div>
        </div>
    ...
    if has_used_interview(user_email):
        ...
        ">
            ...
            <div style="font-size:15px; color:#94a3b8; max-width:460px;
                        margin:0 auto 24px auto; line-height:1.7;">
                Each account gets <b style="color:#00d4ff;">1 free AI interview</b>
                with LISA. You have already used yours.<br><br>
                Head to <b style="color:#f0f4ff;">History</b> to download
                your PDF report and review your feedback.
            </div>
            <div style="font-size:12px; color:#374151;">
                Want more interviews? Register with a new email or contact us to upgrade.
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        with col1:
            if st.button("📋 View My History", use_container_width=True,
                ...
                st.rerun()
        with col2:
            if st.button("📥 Download My Report", use_container_width=True):
                st.session_state.page = "history"
                st.rerun()
        return
    ...
    c2.info("**2. Start Interview**\n4 Easy → 3 Medium → 3 Hard + Adaptive")
...
# # from auth.login import logout_user
# # from interview.interview_engine import interview_flow
# # from database.db import get_user_interviews, has_used_interview
# # from utils.resume_parser import extract_resume_text
...
# #                 Each account gets <b style="color:#00d4ff;">1 free AI interview</b>.
# #                 You have already completed yours.
# #                 Check your History tab to download your PDF report.
# #             </div>
# #             <div style="font-size:13px; color:#4b5563;">
# #                 Want more interviews? Contact us to upgrade your account.
# #             </div>
# #         </div>
# #         """, unsafe_allow_html=True)
...
# #         col1, col2 = st.columns(2)
# #         with col1:
# #             if st.button("📋 View My History", use_container_width=True, type="primary"):
# #                 st.session_state.page = "history"
# #                 st.rerun()
# #         with col2:
# #             if st.button("📥 Download My Report", use_container_width=True):
